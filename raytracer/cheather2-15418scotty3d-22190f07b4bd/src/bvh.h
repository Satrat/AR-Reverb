...
class BVHAccel : public Aggregate {
 ...
 private:
  ...
  bool splitNode(const std::vector<Primitive *> &_primitives,
                         size_t max_leaf_size,
                         BVHNode* parent);
  bool searchNode(BVHNode *parent,const Ray &ray) const;
  bool searchNode(BVHNode *parent,const Ray &ray, Intersection *i) const;
  void deallocNode(BVHNode * parent);
};
